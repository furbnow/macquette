import convertObjectArrayToCSV, { cleanCSVcell } from '../convertObjectArrayToCSV';

describe('cleanCSVcell', () => {
    test('string with leading/trailing spaces', () => {
        const input = '   A string stored in the Assessment data can contain leading/trailing spaces. '
        const output = 'A string stored in the Assessment data can contain leading/trailing spaces.'
