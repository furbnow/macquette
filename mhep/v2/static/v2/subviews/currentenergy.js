let currEnergyReactified = window.features.includes('new-current-energy');
...
function currentenergy_UpdateUI() {
    if (currEnergyReactified) {
        window.Macquette.uiModules.currentEnergy.update();
    } else {
...
function currentenergy_UnloadUI() {
    if (currEnergyReactified) {
        window.Macquette.uiModules.currentEnergy.unmountAll();
    }
}
