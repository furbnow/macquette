      ...
      <>
        <div className="d-flex justify-content-between align-items-center mb-30">
          <h2 className="ma-0">
            ...
            {state.currentPage === null ? '' : pageTitles[state.currentPage] ?? ''}
          </h2>
        ...
        {state.houseGraphicShown &&
          state.isScenarioPage &&
          state.graphicsInput !== null && <Graphics input={state.graphicsInput} />}
      </>
    );
  },
  initialState: () => {
      ...
      return Result.ok<Action[]>([
        {
          ...
          state: {
            ...
            scenarioLocked:
              route.type === 'with scenario' && (currentScenario?.locked ?? false),
            graphicsInput: getGraphicsInput(scenarioId ?? '', currentScenario),
          },
        },
      ]);
    },
