  ...
  return (
    <>
      <FormGrid>
        ...
        <NumberInput
          id={wallThicknessId}
          value={state.wallThickness === null ? null : state.wallThickness * 1000}
          onChange={(value) =>
            mergeInput({
  ...
  return (
    <>
      <LabelWithInfo
        ...
        infoText={
          <>
            This is the distance that the edge insulation extends horizontally away from
            the wall, along the underside of the floor slab. It is <b>not</b> the
  ...
  return (
    <>
      <LabelWithInfo
        ...
        infoText={
          <>
            This is the distance that the edge insulation extends vertically downwards
            below the ground level, adjacent to the foundation wall. It is <b>not</b> the
            thickness of the insulation material.
          </>
        }
      >
