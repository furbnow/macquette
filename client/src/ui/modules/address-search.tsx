...
function WithOriginInput<T, U>({
  ...
  return (
    <>
      ...
      {data.type === 'user provided' && <div>{inputComponent(data, data.value)}</div>}
  ...
  return (
    <section>
      ...
      <FormGrid>
        ...
        <span>
          ...
          <small style={{ display: 'block', width: '35em' }}>
            ...
            <br />
            The planning authority for properties within National Parks is usually the
            National Park Authority rather than the local authority. You can check the
      ...
      <div className="text-callout mb-15">
        <p>
          In exposed locations, water ingress from driving rain is more likely, so
          measures like cavity and internal wall insulation will require careful
          consideration and might not be appropriate.
        </p>
        <p>
          In areas of severe frost exposure, cavity wall insulation, internal insulation,
          materials used and external finishes will need careful consideration.
        </p>
        <p>
          You can find{' '}
          <a
      ...
      <div className="text-callout mb-15">
        <p>
          ...
          considered. This is likely to affect decisions including floor insulation and
          construction, wall and floor finishes, and the position of services.
        </p>
      ...
      <div className="text-callout mb-15">
        <p>
          ...
          making the home more air-tight, it might be necessary to:
        </p>
        <ul>
          <li>add a below-floor sump to draw radon away from occupied spaces</li>
          <li>
            adjust the ventilation strategy for the home to manage radon levels internally
          </li>
          <li>consider an alternative ground floor build up </li>
        </ul>

        <p>
          Specialist advice should be sought on the best approach for each home. As part
          of making a retrofit plan you should establish the existing radon levels and
          level of risk by:
        </p>
        <ul>
          <li>
            Consulting the map of &apos;at risk&apos; areas at scenario planning stage.
          </li>
          <li>
            Obtaining{' '}
          ...
          <li>
            If the individual property report confirms a heightened risk, we recommend
            that{' '}
  ...
  shims: {
    extractUpdateAction: ({ project }) => {
      ...
      const action: ExternalDataAction = {
        ...
        state: {
          ...
          uniquePropertyReferenceNumber: household?.uniquePropertyReferenceNumber ?? {
            type: 'no data',
          },
          ...
          floodingSurfaceWater:
            coalesceEmptyString(household?.flooding_surface_water, null) ?? null,
          floodingReservoirs:
            coalesceEmptyString(household?.flooding_reservoirs, null) ?? null,
          floodingGroundwater:
            coalesceEmptyString(household?.flooding_groundwater, null) ?? null,
      ...
      action.state.address = ignoreAddress
        ...
        : fromValues<Address, never>(addressLegacy, household?.address_full ?? null);
    ...
    mutateLegacyData: (
      ...
      for (const scenario of Object.values(dataAny)) {
        ...
        scenarioAny.region = getWithOriginValue(state.region)?.index0 ?? undefined;
        ...
        householdAny.address_lsoa = getWithOriginValue(state.lowerLayerSuperOutputArea);
