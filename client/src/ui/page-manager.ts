...
export class PageManager {
  ...
  async handleNavigation() {
    ...
    if (pageData.style === 'legacy') {
      ...
      if (element === null) {
        throw new Error('main content area not available for view initialisation');
      }
      /*
...
class TitleManager {
  private titleModule: InstantiatedUiModule<titleModule.State, titleModule.Action, never>;
  constructor() {
