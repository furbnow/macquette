...
import { constructAppliances, extractAppliancesInputFromLegacy } from './modules/appliances';
import { constructCooking, extractCookingInputFromLegacy } from './modules/cooking';
...
import { LightingSAP, extractLightingSAPInputFromLegacy } from './modules/lighting-appliances-cooking/lighting-sap';
...
calc.run = function (datain) {
    ...
    const lighting = new LightingSAP(extractLightingSAPInputFromLegacy(validatedScenario), { fuels, floors, occupancy, fabric })
    ...
    lighting.mutateLegacyData(calc.data)
    appliances.mutateLegacyData(calc.data)
    cooking.mutateLegacyData(calc.data)
...
calc.ventilation = function (data) {
    ...
    const num_of_floors = data.num_of_floors_override ? data.num_of_floors_override : data.floors.length;
...
calc.fabric_energy_efficiency = function (data) {
    ...
    const lighting = new LightingSAP(extractLightingSAPInputFromLegacy(validatedScenarioFEE), { fuels, floors, occupancy, fabric })
    ...
    lighting.mutateLegacyData(data_FEE)
    appliances.mutateLegacyData(data_FEE)
    cooking.mutateLegacyData(data_FEE)
