...
import {
  ...
  PerFloorTypeSpec,
  SuspendedFloorSpec,
} from '../../../../src/data-schemas/scenario/fabric/floor-u-value';
import { Proportion } from '../../../../src/helpers/proportion';
import { FloorSpec } from '../../../../src/model/modules/fabric/element-types';
...
export const arbPerFloorTypeSpec: fc.Arbitrary<PerFloorTypeSpec> = fc.record({
  ...
  solid: fc.record({
    ...
    edgeInsulation: fc.record({
      ...
      vertical: merge(arbInsulationSpec, fc.record({ depth: fc.option(sensibleFloat) })),
      horizontal: merge(
        arbInsulationSpec,
