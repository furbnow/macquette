...
describe('datasets shims', () => {
  ...
  describe('latitudeRadians', () => {
    it('gets an expected value', () => {
      expect(latitudeRadians(new Region('UK average'))).toBeApproximately(0.9337511);
    });
  });
  describe('solarDeclinationRadians', () => {
    it('gets an expected value', () => {
      expect(solarDeclinationRadians(new Month('January'))).toBeApproximately(-0.3612832);
    });
  });
